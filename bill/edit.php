...
<body>
    ...
    <header class="d-flex justify-content-between my-4">
        ...
        <form action="process.php" method="post">
            ...
            <div class="form-elemnt my-4">
                <input type="text" class="form-control" name="ticket" placeholder="Enter Ticket Number" value="<?php echo $row["ticket"]; ?>">
            </div>
            <div class="form-elemnt my-4">
            ...
            <div class="form-elemnt my-4">
                <select name="payment_status"  id="" class="form-control">
                    <option value="" aria-readonly="" ><?php echo $row["payment_status"]; ?> :Current Value</option>
