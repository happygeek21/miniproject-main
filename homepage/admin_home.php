...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="nav_links">
            ...
            <ul>
                ...
                <li><a href="http://localhost/miniproject-main/db_fetch/index.php">Manage User Data</a></li>
                <li><a href="http://localhost/miniproject-main/user_info/index.php">Manage User Info</a></li>
                <li><a href="http://localhost/miniproject-main/bill/index.php">Manage Bill</a></li>
    ...
    <div class="desc">
        <h2>Welcome To H&A Phone Repairs</h2>
       <a href="http://localhost/miniproject-main/registration/indexreg.php"> <input type="button" name=button1 class="button-30"  value="Register Now"></a>
